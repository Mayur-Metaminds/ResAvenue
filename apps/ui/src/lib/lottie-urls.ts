...
export const CONVERSION_FIRST_INNER = `${ROOT}/direct-connect/Conversion_first_bookings_inner.json`
export const CONVERSION_FIRST_OUTER = `${ROOT}/direct-connect/conversion_first_bookings_outer.json`
