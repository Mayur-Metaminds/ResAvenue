...
import { HeroSequenceAnimation } from "@/components/landing/HeroSequenceAnimation"
        ...
        <div className="relative z-10 flex w-full flex-1 items-center justify-center">
          <div className="relative w-full max-w-[800px]">
            ...
            <div className="relative aspect-[1380/884] w-full overflow-hidden">
              ...
              /> */}
              {/* NEW: Transparent PNG sequence animation overlay */}
              <HeroSequenceAnimation className="absolute inset-0 z-50 h-full w-full pointer-events-none object-contain" />
            </div>
