...
export function DirectConnectDeepDiveSection() {
  ...
  return (
    <section className="w-full bg-[#010C28] px-4 py-[60px] md:px-8 lg:py-[120px]">
      <div className="container mx-auto max-w-[1200px]">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
          {/* Left Column: Image Graphic */}
          <div className="relative order-2 flex w-full items-center justify-center lg:order-1 lg:pr-8">
            <img
          ...
          <div className="order-1 flex w-full flex-col lg:order-2 xl:max-w-[480px]">
            {/* Header */}
            <SectionHeader
              theme="dark"
            ...
            <div className="flex flex-col gap-3">
              {accordionData.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-5 p-5 select-none lg:p-6">
                      <div
                        className={cn(
                      ...
                      <h4
                        className={cn(
                          "font-plus-jakarta-700 text-[18px] transition-colors duration-300 lg:text-[19px]",
                    ...
                    <div
                      className={cn(
                        "overflow-hidden px-5 transition-all duration-300 ease-in-out lg:px-6",
                        isOpen
                          ? "max-h-[200px] pb-5 opacity-100 lg:pb-6"
                          : "max-h-0 pb-0 opacity-0"
                      )}
                    >
                      <p className="font-source-sans-400 pl-[54px] text-[15px] leading-[1.6] text-[#94A3B8] lg:text-[16px]">
                        {item.description}
                      </p>
                    </div>
                  </div>
