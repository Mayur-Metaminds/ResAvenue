...
const solutions: SolutionCard[] = [
  ...
  },
  {
    ...
    showLearnMore: false,
    modalAnimationClassName: "lg:scale-85 xl:-mt-10",
  ...
  },
  {
    ...
    anchor: "top-left",
    modalAnimationClassName: "h-full w-full scale-110 z-10 xl:-mt-10 xl:-ml-5",
    modalFeatures: [
    ...
    animationContainerClassName: "absolute inset-x-0 bottom-0 z-0 mx-6 flex h-[150px] items-end justify-center pointer-events-none transition-transform duration-500 group-hover:scale-105 lg:inset-x-auto lg:-bottom-10 xl:-bottom-14 lg:right-10 lg:mx-0 lg:h-[300px] lg:w-[40%] xl:w-[50%] lg:items-end lg:justify-end",
  ...
  },
  {
    ...
    modalWidth: "w-full",
    modalHeight: " lg:h-[590px] xl:h-[500px]",
